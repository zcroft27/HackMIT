...
ALTER TABLE ocean DROP CONSTRAINT ocean_user_id_fkey;
ALTER TABLE bottle DROP CONSTRAINT bottle_user_id_fkey;
ALTER TABLE seen_bottles DROP CONSTRAINT seen_bottles_user_id_fkey;

-- Drop old indexes on user_id columns
DROP INDEX idx_ocean_user_id;
DROP INDEX idx_bottle_user_id;
DROP INDEX idx_bottle_tag_user;
DROP INDEX idx_seen_bottles_user_id;
DROP INDEX idx_seen_bottles_user_seen;
...
-- Update the primary key for seen_bottles table
ALTER TABLE seen_bottles DROP CONSTRAINT seen_bottles_pkey;
